...
public class CarRental {
	...
	public static void main(String[] args) {
		...
		System.out.println(car.vehicleName + " " + car.feature + " "+car.fuelType+ " " + trip2.fromCity + "-" + trip2.toCity);
		...
		System.out.println(suv.vehicleName + " " + suv.feature + " " +suv.fuelType+" "+ trip3.fromCity + "-" + trip3.toCity);
